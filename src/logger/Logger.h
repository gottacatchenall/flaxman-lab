...
class Logger{
    ...
    public:
        ...
        void write_effective_migration_rates(std::string gen_dir_path, std::vector<std::vector<double>> eff_mig_rates);
        ...
        void write_patch_ld();
        void write_generation_data(int gen, std::vector<std::vector<int>> map, std::vector<std::vector<double>> eff_mig_rates, int n_total);
};
